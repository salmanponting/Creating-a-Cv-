        ...
        <div class="container">
          <div class="row">
            <div class="col-md-3 text-left text-md-center mb-3">
              <img class="rounded-circle img-fluid" src="{{asset('image/jj.jpg')}}"  alt="Profile Photo" />
            </div>
            <div class="col-md-9">
              <h1>salman</h1>
        ...
        <div class="container">
         <div class="row p-3">
           <div class="col-md pb-2 pb-md-0">
              ...
              <a href="#" class="text-white ml-2">salman19941@live.com</a>
           </div>
           <div class="col-md text-md-center pb-2 pb-md-0">
              ...
              <a href="#" class="text-white ml-2">drasticplays.com</a>
            </div>       
            <div class="col-md text-md-right">
              ...
              <a href="#" class="text-white ml-2">+4740572103</a>
            </div>       
          </div>
        </div>
      </nav>
